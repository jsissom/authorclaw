...
const GOAL_TEMPLATES: GoalTemplate[] = [
  ...
  {
    type: 'analysis',
    label: 'Style & Voice Analysis',
    description: 'Analyze writing style and create a voice profile',
    steps: [
      {
        label: 'Style analysis',
        skill: 'style-clone',
        toolSuggestion: 'manuscript-autopsy',
        taskType: 'style_analysis',
        promptTemplate: 'Analyze the writing style in: {{description}}. Examine: sentence length distribution, vocabulary complexity, dialogue-to-narrative ratio, POV handling, tense consistency, favorite constructions, rhythm patterns, and emotional register.',
      },
      {
        label: 'Voice profile creation',
        skill: 'style-clone',
        toolSuggestion: 'ai-author-library',
        taskType: 'style_analysis',
        promptTemplate: 'Based on the style analysis, create a detailed voice profile. Include: characteristic sentence patterns, vocabulary preferences, common metaphor types, dialogue style, paragraph structure, and a list of do\'s and don\'ts for matching this voice.',
      },
      {
        label: 'Writing sample test',
        skill: 'write',
        taskType: 'creative_writing',
        promptTemplate: 'Using the voice profile we created, write a 500-word sample scene that demonstrates this author\'s voice. Then compare it to the original and note any differences.',
      },
    ],
  },
  {
    ...
    description: 'Compile and format the manuscript for distribution',
    steps: [
      {
        label: 'Compile manuscript',
        skill: 'format',
        toolSuggestion: 'creator-asset-suite',
        taskType: 'general',
        promptTemplate: 'Compile the manuscript for: {{description}}. Assemble all chapters in order, add front matter (title page, copyright, dedication), and create a table of contents.',
      },
      {
        label: 'Final proofread',
        skill: 'revise',
        taskType: 'final_edit',
        promptTemplate: 'Perform a final proofread on the compiled manuscript: {{description}}. Check for: typos, grammar errors, formatting inconsistencies, missing scene breaks, and chapter numbering.',
      },
    ],
  },
];
